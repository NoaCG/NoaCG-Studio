...
const ALLOWED = [
  ...
  { file: 'docs.html', line: '<strong>SPX</strong></td>', why: "the 'which package do I want' table's row for folder-loading playout, named beside OBS/vMix, CasparCG, OGraf, LiveOS and H2R - a reader running it has to find their own row" },
