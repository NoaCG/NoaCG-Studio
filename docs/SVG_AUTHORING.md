...
There are twelve: a **quiz**, a **score tracker**, a **live vote**, a **countdown**, a **meter**,
an **alert**, a **survey board**, a **stepped list**, a **lineup**, a **puzzle board**, a
**reveal** and a **bingo caller**. You draw what each moment looks like; NoaCG decides when each
one is on. Your artwork is never redrawn.
