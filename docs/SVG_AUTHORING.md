...
There are eleven: a **quiz**, a **score tracker**, a **live vote**, a **countdown**, a **meter**,
an **alert**, a **survey board**, a **stepped list**, a **lineup**, a **puzzle board** and a
**reveal**. You draw what each moment looks like; NoaCG decides when each one is on. Your artwork
is never redrawn.
...
NoaCG lays the phrase you type over the tiles, hides every letter, and shows each as you add it
to the Revealed letters box. Solve shows the rest.
...
Four to forty tiles, numbered left to right and then down; the phrase is laid over them in that order, so put spaces where the tiles should stay blank. The operator gets Solve and New puzzle, plus the Puzzle box (the phrase) and the Revealed letters box you add each called letter to.
