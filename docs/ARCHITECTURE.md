...
| model -> templates | `model/wizard.ts:14-15` `export *` of `templates/contract.ts` + `templates/importedDesign/designTypes.ts` | temporary, one landing (domain row 1 of the 2026-09-06 workflow plan) - rewrite the importers to the new paths, then delete the shim and its `.dependency-cruiser.cjs` allowance together |
