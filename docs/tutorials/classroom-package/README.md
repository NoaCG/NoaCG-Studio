...
- Change the colours, fonts and shapes as much as you like. Keep the layer names.
- Text = what you type on air. Moments = hidden, NoaCG shows them. Board = stays as drawn.
