...
raised: 2026-09-25
state: unstarted
found: "at 1366x768 the production page's top bar shows the production Quiz Night as Quiz ..., so a ten-letter name does not fit"
serves: NOW
size: small
...
# The production top bar cuts a ten-letter name
...
out, so the name gets what is left, which is about 40 px.
