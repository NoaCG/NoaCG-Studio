...
state: advanced
note: >-
  The mechanism this ask needs landed: 0040657c compiled a behaviour from a declaration
  ...
  No recipe in src/templates/behaviours/ reorders rows - the one sort in that directory,
  naming.ts:100, orders keys - so the reordering half is untouched, as are levels 2 and 3.
