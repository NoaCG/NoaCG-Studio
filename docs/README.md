...
| `PRODUCT_AND_MAP.md` | What NoaCG Studio is, the pillars in prose, the commands, and where the code lives. Orientation a reader takes in once - the rules that bind are compiled into `AGENTS.md` files from `contracts/rules/`. |
