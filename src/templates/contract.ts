...
//
// THE TEMPLATE CONTRACT: what every catalog design declares and every wizard surface reads. The
// assembler ids and categories, the options the flow collects, the curated palettes, the field
// plans, the style choices and the option/field resolvers all live here, next to the catalog they
// describe. The Import-graphic road's own shapes (`DesignSvg*`, `DesignArt`) live in
// importedDesign/designSvgTypes.ts and appear here only as members of WizardOptions.
...
import type { DesignArt, DesignSvg } from './importedDesign/designSvgTypes';
