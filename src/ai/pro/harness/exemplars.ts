...
export const EXEMPLAR_CORPORA: readonly ExemplarCorpus[] = [
  ...
  {"category":"corner-bug","typeIds":["award-bug","event-bug","live-bug","logo-bug","sponsor-bug","sponsor-rotator","sponsor-strip","station-bug","status-chip"],"designs":40,"files":48,"typeSizes":[{"role":"name","sizes":{"n":32,"min":16,"median":16,"max":30}},{"role":"extra","sizes":{"n":16,"min":16,"median":16,"max":24}},{"role":"title","sizes":{"n":16,"min":16,"median":16,"max":24}}],"paddingBlock":{"n":33,"min":8,"median":15,"max":20},"paddingInline":{"n":33,"min":9,"median":22,"max":30},"gap":{"n":34,"min":6,"median":15,"max":38},"radius":{"n":8,"min":3,"median":19,"max":999},"tracking":{"n":1,"min":0.06,"median":0.06,"max":0.06},"lineHeight":{"n":51,"min":1,"median":1.2,"max":1.3}},
  ...
  {"category":"game-timer","typeIds":["countdown"],"designs":9,"files":12,"typeSizes":[{"role":"clock","sizes":{"n":9,"min":58,"median":88,"max":104}},{"role":"mask","sizes":{"n":6,"min":20,"median":25,"max":58}},{"role":"label","sizes":{"n":3,"min":20,"median":20,"max":20}}],"paddingBlock":{"n":11,"min":4,"median":12,"max":26},"paddingInline":{"n":11,"min":5,"median":34,"max":46},"gap":{"n":2,"min":11,"median":17.5,"max":24},"radius":{"n":2,"min":60,"median":529.5,"max":999},"tracking":{"n":5,"min":0.01,"median":0.01,"max":0.02},"lineHeight":{"n":15,"min":1,"median":1.2,"max":1.32}},
  {"category":"info-card","typeIds":["headline-card","listing-card","notice-card","now-next","offer-card","process-steps","product-card","qr-card","statement-card","title-card","topic-card"],"designs":86,"files":81,"typeSizes":[{"role":"title","sizes":{"n":30,"min":21,"median":27.5,"max":92}},{"role":"extra","sizes":{"n":21,"min":20,"median":24,"max":34}},{"role":"name","sizes":{"n":21,"min":20,"median":56,"max":112}},{"role":"detail","sizes":{"n":14,"min":20,"median":20.5,"max":26}},{"role":"label","sizes":{"n":11,"min":20,"median":20,"max":20}},{"role":"kicker","sizes":{"n":9,"min":20,"median":20,"max":26}},{"role":"claim","sizes":{"n":5,"min":47,"median":72,"max":78}},{"role":"head","sizes":{"n":5,"min":33,"median":36,"max":43}}],"paddingBlock":{"n":71,"min":0,"median":24,"max":72},"paddingInline":{"n":71,"min":0,"median":36,"max":250},"gap":{"n":27,"min":10,"median":18,"max":33},"radius":{"n":12,"min":3,"median":4.5,"max":999},"tracking":{"n":35,"min":-0.02,"median":0.03,"max":0.1},"lineHeight":{"n":170,"min":0.8,"median":1.25,"max":1.45}},
  {"category":"infographic","typeIds":["agenda","fixtures","goal-meter","key-facts","milestone-track","poll","recap-card"],"designs":42,"files":52,"typeSizes":[{"role":"heading","sizes":{"n":18,"min":20,"median":21,"max":54}},{"role":"value","sizes":{"n":12,"min":22,"median":75,"max":150}},{"role":"label","sizes":{"n":11,"min":20,"median":22,"max":50}},{"role":"kicker","sizes":{"n":10,"min":20,"median":20,"max":24}},{"role":"mid","sizes":{"n":8,"min":20,"median":21.5,"max":25}},{"role":"unit","sizes":{"n":6,"min":20,"median":34.5,"max":44}},{"role":"line","sizes":{"n":5,"min":20,"median":21,"max":22}},{"role":"sub","sizes":{"n":5,"min":20,"median":20,"max":20}}],"paddingBlock":{"n":59,"min":0,"median":23,"max":66},"paddingInline":{"n":59,"min":0,"median":30,"max":124},"gap":{"n":51,"min":4,"median":23,"max":38},"radius":{"n":8,"min":2,"median":32,"max":999},"tracking":{"n":17,"min":-0.02,"median":-0.01,"max":0.09},"lineHeight":{"n":98,"min":0.94,"median":1.2,"max":1.4}},
  {"category":"lower-third","typeIds":["call-to-action","lower-third","social-bug"],"designs":104,"files":111,"typeSizes":[{"role":"name","sizes":{"n":97,"min":20,"median":46,"max":68}},{"role":"title","sizes":{"n":80,"min":20,"median":24,"max":49}},{"role":"extra","sizes":{"n":58,"min":20,"median":20,"max":48}},{"role":"role","sizes":{"n":7,"min":20,"median":24,"max":26}},{"role":"action","sizes":{"n":4,"min":20,"median":22,"max":64}},{"role":"clock","sizes":{"n":4,"min":20,"median":31.5,"max":65}},{"role":"target","sizes":{"n":4,"min":31,"median":36,"max":40}},{"role":"reason","sizes":{"n":3,"min":20,"median":20,"max":20}}],"paddingBlock":{"n":127,"min":0,"median":18,"max":58},"paddingInline":{"n":127,"min":0,"median":34,"max":224},"gap":{"n":42,"min":4,"median":14,"max":30},"radius":{"n":14,"min":2,"median":10.5,"max":999},"tracking":{"n":35,"min":-0.02,"median":0.02,"max":0.22},"lineHeight":{"n":280,"min":0.72,"median":1.2,"max":1.46}},
  ...
  {"category":"quiz","typeIds":["answer-board-2","answer-board-3","quiz-board","quiz-show"],"designs":15,"files":20,"typeSizes":[{"role":"letter","sizes":{"n":15,"min":20,"median":22,"max":38}},{"role":"mask","sizes":{"n":15,"min":36,"median":38,"max":44}},{"role":"text","sizes":{"n":15,"min":22,"median":26,"max":32}}],"paddingBlock":{"n":29,"min":0,"median":26,"max":40},"paddingInline":{"n":29,"min":0,"median":40,"max":110},"gap":{"n":14,"min":12,"median":12.5,"max":20},"radius":{"n":19,"min":0,"median":6,"max":12},"tracking":{"n":3,"min":0.04,"median":0.04,"max":0.04},"lineHeight":{"n":29,"min":1.12,"median":1.15,"max":1.46}},
  ...
  {"category":"scoreboard","typeIds":["duel-score","match-board","match-event","match-status","podium-score","scoreboard","scorebug","speaking-timer"],"designs":29,"files":40,"typeSizes":[{"role":"score","sizes":{"n":29,"min":20,"median":44,"max":80}},{"role":"team","sizes":{"n":24,"min":24,"median":35,"max":48}},{"role":"clock","sizes":{"n":11,"min":21,"median":32,"max":62}},{"role":"phase","sizes":{"n":11,"min":20,"median":20,"max":26}},{"role":"dash","sizes":{"n":5,"min":38,"median":42,"max":50}},{"role":"label","sizes":{"n":5,"min":20,"median":20,"max":20}},{"role":"name","sizes":{"n":5,"min":20,"median":25,"max":46}},{"role":"club","sizes":{"n":4,"min":24,"median":32,"max":34}}],"paddingBlock":{"n":70,"min":0,"median":11.5,"max":30},"paddingInline":{"n":70,"min":0,"median":24,"max":44},"gap":{"n":70,"min":1,"median":15,"max":44},"radius":{"n":9,"min":2,"median":6,"max":999},"tracking":{"n":9,"min":-0.005,"median":0.04,"max":0.2},"lineHeight":{"n":104,"min":1,"median":1.1,"max":1.35}},
  {"category":"starting-soon","typeIds":["holding-screen","sign-off"],"designs":24,"files":29,"typeSizes":[{"role":"clock","sizes":{"n":15,"min":24,"median":46,"max":280}},{"role":"show","sizes":{"n":15,"min":30,"median":68,"max":96}},{"role":"kicker","sizes":{"n":11,"min":20,"median":24,"max":28}},{"role":"note","sizes":{"n":9,"min":24,"median":26,"max":30}},{"role":"message","sizes":{"n":7,"min":68,"median":72,"max":78}},{"role":"next","sizes":{"n":7,"min":24,"median":25,"max":30}},{"role":"title","sizes":{"n":7,"min":22,"median":24,"max":112}},{"role":"label","sizes":{"n":6,"min":20,"median":23,"max":58}}],"paddingBlock":{"n":32,"min":0,"median":32,"max":64},"paddingInline":{"n":32,"min":14,"median":60,"max":140},"gap":{"n":11,"min":14,"median":18,"max":33},"radius":{"n":9,"min":0,"median":72,"max":999},"tracking":{"n":17,"min":-0.02,"median":0.04,"max":0.06},"lineHeight":{"n":70,"min":0.86,"median":1.15,"max":1.4}},
